# Install Azure Blob Storage CSI driver v1.27.10 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.27.10/deploy/install-driver.sh | bash -s v1.27.10 blobfuse-proxy --
```
...
cd blob-csi-driver
./deploy/install-driver.sh v1.27.10 local,blobfuse-proxy
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.27.10/deploy/uninstall-driver.sh | bash -s v1.27.10 --
```
...
git clone https://github.com/kubernetes-sigs/blob-csi-driver.git
cd blob-csi-driver
git checkout v1.27.10
./deploy/uninstall-driver.sh v1.27.10 local
```
