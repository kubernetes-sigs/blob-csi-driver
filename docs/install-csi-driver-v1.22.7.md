# Install Azure Blob Storage CSI driver v1.22.7 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.22.7/deploy/install-driver.sh | bash -s v1.22.7 blobfuse-proxy --
```
...
cd blob-csi-driver
./deploy/install-driver.sh v1.22.7 local,blobfuse-proxy
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.22.7/deploy/uninstall-driver.sh | bash -s v1.22.7 --
```
...
./deploy/uninstall-driver.sh v1.22.7 local
```
