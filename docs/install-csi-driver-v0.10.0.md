# Install Azure Blob Storage CSI driver v0.10.0 version on a kubernetes cluster
...
## Install with kubectl
 - remote install
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v0.10.0/deploy/install-driver.sh | bash -s v0.10.0 --
```
...
cd blob-csi-driver
./deploy/install-driver.sh v0.10.0 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v0.10.0/deploy/uninstall-driver.sh | bash -s v0.10.0 --
```
