# Install Azure Blob Storage CSI driver v1.4.1 version on a kubernetes cluster
...
## Install with kubectl
 - remote install
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.4.1/deploy/install-driver.sh | bash -s v1.4.1 --
```
...
cd blob-csi-driver
./deploy/install-driver.sh v1.4.1 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.4.1/deploy/uninstall-driver.sh | bash -s v1.4.1 --
```
