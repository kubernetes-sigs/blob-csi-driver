# Install Azure Blob Storage CSI driver v1.26.18 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.26.18/deploy/install-driver.sh | bash -s v1.26.18 blobfuse-proxy --
```
...
cd blob-csi-driver
./deploy/install-driver.sh v1.26.18 local,blobfuse-proxy
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.26.18/deploy/uninstall-driver.sh | bash -s v1.26.18 --
```
...
git clone https://github.com/kubernetes-sigs/blob-csi-driver.git
cd blob-csi-driver
git checkout v1.26.18
./deploy/uninstall-driver.sh v1.26.18 local
```
