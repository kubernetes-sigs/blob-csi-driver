# Install Azure Blob Storage CSI driver v1.11.0 version on a kubernetes cluster
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/blob-csi-driver/v1.11.0/deploy/uninstall-driver.sh | bash -s v1.11.0 blobfuse-proxy --
```
