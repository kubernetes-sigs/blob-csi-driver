...
type BlobfuseCapabilitiesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BlobfuseCapabilitiesRequest) Reset() {
	*x = BlobfuseCapabilitiesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_azure_blob_mount_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BlobfuseCapabilitiesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlobfuseCapabilitiesRequest) ProtoMessage() {}

func (x *BlobfuseCapabilitiesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_azure_blob_mount_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlobfuseCapabilitiesRequest.ProtoReflect.Descriptor instead.
func (*BlobfuseCapabilitiesRequest) Descriptor() ([]byte, []int) {
	return file_azure_blob_mount_proto_rawDescGZIP(), []int{2}
}

func (x *BlobfuseCapabilitiesRequest) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
type BlobfuseCapabilitiesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DistributedCacheSupported bool `protobuf:"varint,1,opt,name=distributedCacheSupported,proto3" json:"distributedCacheSupported,omitempty"`
}

func (x *BlobfuseCapabilitiesResponse) Reset() {
	*x = BlobfuseCapabilitiesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_azure_blob_mount_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *BlobfuseCapabilitiesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlobfuseCapabilitiesResponse) ProtoMessage() {}

func (x *BlobfuseCapabilitiesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_azure_blob_mount_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlobfuseCapabilitiesResponse.ProtoReflect.Descriptor instead.
func (*BlobfuseCapabilitiesResponse) Descriptor() ([]byte, []int) {
	return file_azure_blob_mount_proto_rawDescGZIP(), []int{3}
}

func (x *BlobfuseCapabilitiesResponse) GetDistributedCacheSupported() bool {
	if x != nil {
		return x.DistributedCacheSupported
	}
	return false
}
...
var file_azure_blob_mount_proto_rawDesc = []byte{
	...
	0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x39, 0x0a, 0x1b, 0x42, 0x6c, 0x6f, 0x62, 0x66,
	0x75, 0x73, 0x65, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52,
	...
	,
...
var file_azure_blob_mount_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_azure_blob_mount_proto_goTypes = []interface{}{
	...
	(*BlobfuseCapabilitiesRequest)(nil),  // 2: BlobfuseCapabilitiesRequest
	(*BlobfuseCapabilitiesResponse)(nil), // 3: BlobfuseCapabilitiesResponse
}
var file_azure_blob_mount_proto_depIdxs = []int32{
	0, // 0: MountService.MountAzureBlob:input_type -> MountAzureBlobRequest
	2, // 1: MountService.GetBlobfuseCapabilities:input_type -> BlobfuseCapabilitiesRequest
	1, // 2: MountService.MountAzureBlob:output_type -> MountAzureBlobResponse
	3, // 3: MountService.GetBlobfuseCapabilities:output_type -> BlobfuseCapabilitiesResponse
...
func file_azure_blob_mount_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_azure_blob_mount_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlobfuseCapabilitiesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_azure_blob_mount_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlobfuseCapabilitiesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
