...
| v1.27.9        | `mcr.microsoft.com/oss/v2/kubernetes-csi/blob-csi:v1.27.9`      | 1.21+                 |
| v1.26.16       | `mcr.microsoft.com/oss/v2/kubernetes-csi/blob-csi:v1.26.16`     | 1.21+                 |
...
```console
kubectl patch daemonset csi-blob-node -n kube-system -p '{"spec":{"template":{"spec":{"initContainers":[{"env":[{"name":"INSTALL_BLOBFUSE2","value":"true"},{"name":"BLOBFUSE2_VERSION","value":"2.5.4"}],"name":"install-blobfuse-proxy"}]}}}}'
```
