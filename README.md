...
|v1.23.1         |mcr.microsoft.com/oss/kubernetes-csi/blob-csi:v1.23.1 | 1.21+                 |
|v1.22.3         |mcr.microsoft.com/oss/kubernetes-csi/blob-csi:v1.22.3 | 1.21+                 |
|v1.21.5         |mcr.microsoft.com/oss/kubernetes-csi/blob-csi:v1.21.5 | 1.21+                 |
