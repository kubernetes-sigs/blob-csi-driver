...
require (
	...
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.1.9
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/containerservice/armcontainerservice/v6 v6.2.0 // indirect
...
replace (
	...
	github.com/prometheus/client_golang => github.com/prometheus/client_golang v1.16.0 // indirect
	github.com/prometheus/client_model => github.com/prometheus/client_model v0.4.0 // indirect
	github.com/prometheus/common => github.com/prometheus/common v0.44.0 // indirect
	github.com/prometheus/procfs => github.com/prometheus/procfs v0.10.1 // indirect
