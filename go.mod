...
replace (
	go.opentelemetry.io/otel => go.opentelemetry.io/otel v1.18.0
	go.opentelemetry.io/otel/metric => go.opentelemetry.io/otel/metric v1.18.0
	go.opentelemetry.io/otel/trace => go.opentelemetry.io/otel/trace v1.18.0
	...
	sigs.k8s.io/cloud-provider-azure/pkg/azclient => sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.0.30
)
