...
require (
	...
	k8s.io/cloud-provider v0.27.13 // indirect
...
replace (
	github.com/niemeyer/pretty => github.com/niemeyer/pretty v0.0.0-20200227.134842-a10e7caefd8e
